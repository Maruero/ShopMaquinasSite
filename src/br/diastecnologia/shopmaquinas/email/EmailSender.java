...
public class EmailSender {
	...
	public void SendEmail( String subject, String htmlBody, String textBody, Person person ) throws EmailException{
		try{
			...
			throw new EmailException("Problema ao enviar e-mail: " , ex);
		}
	}
}
